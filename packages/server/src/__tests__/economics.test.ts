...
// NOTE (v0.7.0): Skipped due to Miniflare/Workers test pool instability.
// Economic behavior is validated via the conformance suite.
describe.skip('Economics & Limits Hardening', () => {
